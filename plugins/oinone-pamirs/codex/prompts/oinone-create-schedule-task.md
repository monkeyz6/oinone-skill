...
- 文件: `plugins/oinone-pamirs/skills/oinone-create-schedule-task/examples.md`
- 文件: `plugins/oinone-pamirs/skills/oinone-create-schedule-task/reference.md`
- 目录: `plugins/oinone-pamirs/skills/oinone-create-schedule-task/references/`
