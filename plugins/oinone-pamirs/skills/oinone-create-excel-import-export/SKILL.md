---
name: oinone-create-excel-import-export
description: Use when creating oinone-pamirs Excel import or export templates - triggered by requirements involving data export, data import, batch import/export, Excel template definition, or any scenario where a model needs Excel file import/export functionality via the oinone-pamirs file module. Trigger keywords: create import, create export, import export, Excel template, data export, data import, batch import, batch export, export template, import template, Excel import, Excel export. Even if the user does not explicitly say Excel or import/export, trigger this skill when they describe a need to import data from files or export data to spreadsheets within the oinone-pamirs framework. This skill covers ONLY oinone-pamirs framework Excel import/export (ExcelTemplateInit + ExcelImportDataExtPoint/ExcelExportFetchDataExtPoint), NOT generic Java POI/EasyExcel usage.
license: Proprietary
metadata:
  scope: oinone-pamirs
  version: "3.0"
