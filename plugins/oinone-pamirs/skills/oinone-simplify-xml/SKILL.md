---
name: oinone-simplify-xml
description: Use when user asks to simplify, clean up, or remove redundant default attributes from oinone-pamirs UI designer exported XML view files. Triggered by requests involving XML simplification, default attribute removal, view XML cleanup, or reducing XML file size for oinone platform.
---
