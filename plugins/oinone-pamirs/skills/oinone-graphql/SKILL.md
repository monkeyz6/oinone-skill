---
name: oinone-graphql
description: Use when writing, reviewing, or debugging Oinone/Pamirs GraphQL queries and mutations - triggered by requirements involving API documentation, frontend-backend integration, GraphQL examples, or interface specification for Oinone platform models
---
